...
| --- | --- | --- | --- |
| 원 파일에서 Sentence 형식으로 로딩 | 1,021,527 문장 | 33,385 문장 (3.27 %) | 988,142 문장 |
| 세종 말뭉치 문장을 type 1 형식으로 변형 | 988,142 문장 | 2071 문장 (0.210 %) | 986,071 문장 |
| 세종 말뭉치 문장을 type 2 형식으로 변형 | 988,142 문장 | 2286 문장 (0.231 %) | 985,856 문장 |
| 세종 말뭉치 문장을 type 3 형식으로 변형 | 988,142 문장 | 2607 문장 (0.264 %) | 985,535 문장 |
| 세종 말뭉치 어절을 type 1 형식으로 변형 | 1,601,367 (어절, 형태소) 쌍 | 1,415 쌍 (0.018 %) | 1,277,480 쌍 |
| 세종 말뭉치 어절을 type 2 형식으로 변형 | 1,601,367 (어절, 형태소) 쌍 | 1,487 쌍 (0.020 %) | 1,275,639 쌍 |
| 세종 말뭉치 어절을 type 3 형식으로 변형 | 1,601,367 (어절, 형태소) 쌍 | 1,831 쌍 (0.023 %) | 1,050,877 쌍 |
